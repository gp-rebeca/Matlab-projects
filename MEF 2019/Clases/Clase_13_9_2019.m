...
coords=[0:L/nnodes:L;] %Coordenadas nodos, incremento longitud del elemento
%%  Propiedades barra
E=100; %elástico
...
for i=1:nelems %si i es 1, tenemos 1 y 2
    ...
    %En este bucle son fijos w1, E y A.
    %Fuerzas nodales equivalentes
    Fe=zeros(2,1);
    for j=1:2 %porque son dos ptos de integración. El bucle j actualiza con el punto 1 y el punto 2.
        int=int2(j);
        ...
        Fe=Fe+w*N'*(N*q)*J; %es un sumatorio, vas guardando la suma anterior en Fe
    end
