...
E=10; A=100; I=5; AE=E*A; EI=E*I; L=1; q0=1000;
...
%% Elemento 2
Le2=L/2; alfa2=pi/2;
Ke2=[AE/Le2 0 0 -AE/Le2 0 0;...
    0 (12*E*I)/(Le2)^3 (6*E*I)/(Le2)^2 0 -(12*E*I)/(Le2)^3 (6*E*I)/(Le2)^2;...
    0 (6*E*I)/(Le2)^2 (4*E*I)/Le2 0 -(6*E*I)/(Le2)^2 (2*E*I)/Le2;...
    -AE/Le2 0 0 AE/Le2 0 0;...
    0 -(12*E*I)/(Le2)^3 -(6*E*I)/(Le2)^2 0 (12*E*I)/(Le2)^3 -(6*E*I)/(Le2)^2;...
    0 (6*E*I)/(Le2)^2 (2*E*I)/Le2 0 -(6*E*I)/(Le2)^2 (4*E*I)/Le2;];
...
Ke3=[AE/Le3 0 0 -AE/Le3 0 0;...
    0 (12*E*I)/(Le3)^3 (6*E*I)/(Le3)^2 0 -(12*E*I)/(Le3)^3 (6*E*I)/(Le3)^2;...
    0 (6*E*I)/(Le3)^2 (4*E*I)/Le3 0 -(6*E*I)/(Le3)^2 (2*E*I)/Le3;...
    -AE/Le3 0 0 AE/Le3 0 0;...
    0 -(12*E*I)/(Le3)^3 -(6*E*I)/(Le3)^2 0 (12*E*I)/(Le3)^3 -(6*E*I)/(Le3)^2;...
    0 (6*E*I)/(Le3)^2 (2*E*I)/Le3 0 -(6*E*I)/(Le3)^2 (4*E*I)/Le3;];
...
Ke4=[AE/Le4 0 0 -AE/Le4 0 0;...
    0 (12*E*I)/(Le4)^3 (6*E*I)/(Le4)^2 0 -(12*E*I)/(Le4)^3 (6*E*I)/(Le4)^2;...
    0 (6*E*I)/(Le4)^2 (4*E*I)/Le4 0 -(6*E*I)/(Le4)^2 (2*E*I)/Le4;...
    -AE/Le4 0 0 AE/Le4 0 0;...
    0 -(12*E*I)/(Le4)^3 -(6*E*I)/(Le4)^2 0 (12*E*I)/(Le4)^3 -(6*E*I)/(Le4)^2;...
    0 (6*E*I)/(Le4)^2 (2*E*I)/Le4 0 -(6*E*I)/(Le4)^2 (4*E*I)/Le4;];
...
%% Elemento 5
Le5=L; alfa5=-pi/2;
Ke5=[AE/Le5 0 0 -AE/Le5 0 0;...
    0 (12*E*I)/(Le5)^3 (6*E*I)/(Le5)^2 0 -(12*E*I)/(Le5)^3 (6*E*I)/(Le5)^2;...
    0 (6*E*I)/(Le5)^2 (4*E*I)/Le5 0 -(6*E*I)/(Le5)^2 (2*E*I)/Le5;...
    -AE/Le5 0 0 AE/Le5 0 0;...
    0 -(12*E*I)/(Le5)^3 -(6*E*I)/(Le5)^2 0 (12*E*I)/(Le5)^3 -(6*E*I)/(Le5)^2;...
    0 (6*E*I)/(Le5)^2 (2*E*I)/Le5 0 -(6*E*I)/(Le5)^2 (4*E*I)/Le5;];
...
%% Elemento 6
Le6=L; alfa6=-pi/2;
Ke6=[AE/Le6 0 0 -AE/Le6 0 0;...
    0 (12*EI)/(Le6)^3 (6*EI)/(Le6)^2 0 -(12*EI)/(Le6)^3 (6*EI)/(Le6)^2;...
    0 (6*EI)/(Le6)^2 (4*EI)/Le6 0 -(6*E*I)/(Le6)^2 (2*EI)/Le6;...
    -AE/Le6 0 0 AE/Le6 0 0;...
    0 -(12*EI)/(Le6)^3 -(6*EI)/(Le6)^2 0 (12*EI)/(Le6)^3 -(6*EI)/(Le6)^2;...
